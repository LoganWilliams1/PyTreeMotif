...
for i in tqdm(range(50), desc='Testing datasets', position=0, leave=True):
    dataset, implanted_motif, instances = generate_15_4_dataset(600, 14, 4)
    found_motif = find_motif(dataset, 14, 4, print_output=False, show_progress=False)
...
print("14,4 Implanted Motif Tests\n")
for i in range(50):
    print("Test " + str(i + 1))
